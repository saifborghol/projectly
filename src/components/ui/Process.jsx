...
const Process = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-40py-20">
      <div
        ...
        <motion.div className="mb-12 text-center" variants={itemVariants}>
          ...
          >
            <p className="text-[#FFFFFF99] text-[16px] mb-2 max-w-2xl mx-auto">
              With a focus on innovation and efficiency, we help you stay ahead
              in an
            </p>
        ...
        <div className="bg-[#080808] border border-[#191919] border-2 p-4 rounded-[16px] border-t-0 relative">
          <div className="flex flex-wrap justify-center gap-6">
            {processSteps.map((step, index) => (
              <motion.div
                key={index}
                className="w-80 h-80 bg-[#080808] border border-[#191919] border-2 p-8 rounded-[16px] border-t-0 relative overflow-hidden"
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-center">
                  <motion.div
                    className="w-15 h-15 rounded-full border-2 border-white/30 bg-gradient-to-br from-[#4F1AD6] to-[#8059E3] flex items-center justify-center mb-6 shadow-xl shadow-purple-500/30"
                    transition={{ duration: 0.6, ease: "easeInOut" }}
                    whileHover={{
                  ...
                  <h3 className="font-medium text-[24px] mb-4 text-white">
                    {step.title}
                  </h3>
                  <p className="text-[#FFFFFF99] text-[16px] leading-relaxed">
                    {step.description}
                  </p>
                </div>
              </motion.div>
